  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="alert alert-info" role="alert">
        <p class="mb-0">
          <strong>Assisted Registration has been deprecated and will soon be removed from the membership system</strong>
        </p>
        <p>
          We've replaced it with a new onboarding tool which delivers a much better experience for members and club administrators.
        </p>

        <p>
          Contact SCDS or your club's membership system lead if you need help with the new onboarding system.
        </p>

        <p class="mb-0">
          <a href="<?= htmlspecialchars(autoUrl('onboarding')) ?>" class="alert-link">Go to onboarding</a>
        </p>
      </div>

      <hr>

      <h1>Welcome to Assisted Registration <span class="badge bg-danger">Deprecated</span></h1>
      <p class="lead">
      ...
      <?php if (isset($_SESSION['TENANT-' . app()->tenant->getId()]['AssRegEmailError'])) { ?>
        <div class="alert alert-danger">
          ...
          <?php }
          unset($_SESSION['TENANT-' . app()->tenant->getId()]['AssRegEmailError']); ?>
        </div>
      <?php } ?>
