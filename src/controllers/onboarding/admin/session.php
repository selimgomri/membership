  ...
  <div class="row">
    <div class="col-lg-8">
      ...
      <form method="post" class="needs-validation" id="form" novalidate>
        ...
        <?php if ($session->status == 'not_ready') { ?>

          <p>
            <button type="submit" name="action" value="fees" class="btn btn-success">Go to fees</button> <button type="submit" name="action" value="send" class="btn btn-success">Send email</button>
          </p>
