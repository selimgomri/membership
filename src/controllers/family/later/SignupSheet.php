...
<div class="container">
  ...
  <p>
	...
	<p>
		Follow the instructions below to sign up for your <?=htmlspecialchars(app()->tenant->getKey('CLUB_NAME'))?>
		Account.
	</p>
  ...
  <div class="border border-dark p-2 bg-white mb-3 px-5">
	...
	<div class="small text-muted">
		...
		<p>
			<?=htmlspecialchars(app()->tenant->getKey('CLUB_NAME'))?> cannot be responsible for errors in data entered by
			parents.
		</p>
    ...
    <p>
      The user account service is provided to <?=htmlspecialchars(app()->tenant->getKey('CLUB_NAME'))?> by
