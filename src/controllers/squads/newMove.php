...
<div class="container">
	<h1>Squad Move for <?php echo $name; ?></h1>
	<form method="post">
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-10">
	      <input type="date" class="form-control" id="movingDate" name="movingDate" value="<?php echo "2018-07-01"; ?>">
	    </div>
	  </div>
		<button type="submit" class="btn btn-dark mb-3">Save Move</button>
	</form>
</div>
