        ...
        <form method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="squadName" name="squadName" placeholder="Enter Squad Name"
              value="<?=htmlspecialchars($row['SquadName'])?>">
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" id="squadFee" name="squadFee" aria-describedby="squadFeeHelp"
                placeholder="eg 50.00" value="<?=htmlspecialchars($row['SquadFee'])?>">
            </div>
          ...
          <div class="form-group d-none">
            ...
            <input type="text" class="form-control" id="squadCoach" name="squadCoach" placeholder="Enter Squad Coach"
              value="<?=htmlspecialchars($row['SquadCoach'])?>">
          </div>
          <div class="form-group">
            <label for="squadTimetable">Squad Timetable</label>
            <input type="text" class="form-control" id="squadTimetable" name="squadTimetable"
              placeholder="Enter Squad Timetable Address" value="<?=htmlspecialchars($row['SquadTimetable'])?>">
          </div>
          <div class="form-group">
            ...
            <select class="custom-select" id="squadCoC" name="squadCoC" aria-describedby="conductSelectHelpBlock">
              ...
              <option value="<?=htmlspecialchars($codeDetails['ID'])?>"
                <?php if ($row['SquadCoC'] == $codeDetails['ID']) { ?>selected<?php } ?>>
