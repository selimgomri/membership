  ...
  <div class="row">
    <div class="col-md-10 col-lg-8">
      ...
      <div class="cell">
        ...
        <div class="row">
          <div class="col-md">
            <a href="<?=autoUrl("trials/" . $parent['ID'])?>" class="btn btn-block btn-dark btn-outline-light-d">
              Trial Info
            </a>
          </div>
          ...
          <div class="col-md">
            <a href="<?=autoUrl("trials/" . $parent['ID'] . "/recommendations")?>" class="btn btn-block btn-dark btn-outline-light-d">
              Suggest Squad
            </a>
          </div>
