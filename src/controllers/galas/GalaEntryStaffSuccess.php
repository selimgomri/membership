...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      ...
      <?php } else { ?>
      <p>
        The <strong>total fee payable is &pound;<?=number_format(($row['FeeToPay']),2,'.','')?></strong>. If you have entered this amount incorrectly and the parent does not notice, they may incur extra charges from the club or gala host.
      </p>
      <?php } ?>
