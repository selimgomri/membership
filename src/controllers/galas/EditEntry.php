    ...
    <div>
      ...
      <?php if ($row['StripePayment'] != null && bool($row['Paid'])) {
        ...
        <div class="row align-items-center mb-3">
          <div class="col-auto">
            <img src="<?=autoUrl("img/stripe/" . $row['Brand'] . ".png")?>" srcset="<?=autoUrl("img/stripe/" . $row['Brand'] . "@2x.png")?> 2x, <?=autoUrl("img/stripe/" . $row['Brand'] . "@3x.png")?> 3x" style="width:40px;"> <span class="visually-hidden"><?=htmlspecialchars(getCardBrand($row['Brand']))?></span>
          </div>
          <div class="col-auto">
            <p class="my-0">
