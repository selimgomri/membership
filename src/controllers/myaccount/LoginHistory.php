  ...
  <div class="">
    ...
    <nav aria-label="Page navigation">
      <ul class="pagination mt-3 mb-0">
        <?php if ($numLogins <= 10) { ?>
        <li class="page-item active"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page ?>"><?php echo $page ?></a></li>
        <?php } else if ($numLogins <= 20) { ?>
          <?php if ($page == 1) { ?>
          <li class="page-item active"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page ?>"><?php echo $page ?></a></li>
    			<li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page+1 ?>"><?php echo $page+1 ?></a></li>
    			<li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page+1 ?>">Next</a></li>
          <?php } else { ?>
          <li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page-1 ?>">Previous</a></li>
    	    <li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page-1 ?>"><?php echo $page-1 ?></a></li>
    	    <li class="page-item active"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page ?>"><?php echo $page ?></a></li>
          <?php } ?>
        <?php } else { ?>
    			...
    			<li class="page-item active"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page ?>"><?php echo $page ?></a></li>
    	    <li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page+1 ?>"><?php echo $page+1 ?></a></li>
    			<li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page+2 ?>"><?php echo $page+2 ?></a></li>
    			<li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page+1 ?>">Next</a></li>
          <?php } else { ?>
    			<li class="page-item"><a class="page-link" href="<?php echo autoUrl("myaccount/loginhistory/page/"); ?><?php echo $page-1 ?>">Previous</a></li>
          <?php if ($page > 2) { ?>
