...
<div class="container">
  <div class="row">
    <div class="col-lg-8">
      ...
      <p>
        <a href="<?=autoUrl("my-account/googleauthenticator/setup")?>" class="btn btn-dark btn-outline-light-d">
          Setup Again
        </a>
      </p>
      ...
      <p>
        ...
        <a href="<?=autoUrl("my-account/general")?>" class="btn btn-dark btn-outline-light-d">
          Disable All 2FA
        </a>
      </p>
      <?php } ?>
