...
<div class="container">
  ...
  <?php foreach ($strokes as $strokeCode => $stroke) { ?>
    <?php foreach ($distances[$strokeCode] as $distance) {
      ...
      if ($row != null) { ?>
      <div class="p-1 <?php if ($count%2 == 0) { ?>bg-light<?php } ?>">
        <div class="row">
          <div class="col-4 col-md-4 col-lg-2 text-truncate">
            <?=$distance?>m <?=$stroke?>
          </div>
          <div class="col-4 col-md-4 col-lg-2 text-truncate mono">
          ...
          <div class="col-6 col-lg-2 text-truncate" title="<?php if ($row['GalaName'] == null) { ?><?=htmlspecialchars($row['Name'])?><?php } else { ?><?=htmlspecialchars($row['GalaName'])?><?php } ?>">
          ...
          <div class="col-6 text-right text-lg-left col-lg-2 text-truncate">
