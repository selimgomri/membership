...
<body>
  <div style="height:5.398cm;width:8.560cm;background:#eee;position:fixed;border:0.025cm solid #000">
    ...
    <p style="position:fixed;font-size:10pt;margin:2.9cm 0 0 0.25cm;max-width:5.76cm;white-space:normal;overflow:hidden;text-overflow:ellipsis;"><strong><?=htmlspecialchars(env('ASA_CLUB_CODE'))?> Coaches/Volunteers</strong><br>Scan QR Code in emergency for Medical Form and Contact Details</p>

    <p style="position:fixed;font-size:0.5cm;margin:0.25cm 0 0 7.81cm;max-width:5.76cm;white-space:normal;overflow:hidden;text-overflow:ellipsis;writing-mode:vertical-rl;text-orientation:mixed;line-height:1"><span class="mono"><?=htmlspecialchars(env('ASA_CLUB_CODE'))?>X<?=$swimmer['MemberID']?></span></p>
