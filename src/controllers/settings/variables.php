    ...
    <div class="col-md-9">
      <main>
        ...
        <form method="post">
          ...
          <div class="form-group">
            <label for="SWIM_ENGLAND_COUNTY">Swim England County</label>
            <select class="custom-select" id="SWIM_ENGLAND_COUNTY" name="SWIM_ENGLAND_COUNTY">
              <option selected>Choose...</option>
            </select>
          </div>

          <div class="form-group">
            <label for="SWIM_ENGLAND_REGION">Swim England Region</label>
            <select class="custom-select" id="SWIM_ENGLAND_REGION" name="SWIM_ENGLAND_REGION">
              <option selected>Choose...</option>
            </select>
          </div>
          <?php } else { ?>
