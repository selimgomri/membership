        ...
        <form method="post">
          ...
          <div class="form-group">
            ...
            <div class="custom-control custom-radio">
              <input type="radio" id="GOCARDLESS_USE_SANDBOX_TRUE" name="GOCARDLESS_USE_SANDBOX" class="custom-control-input" <?php if (filter_var($vars['GOCARDLESS_USE_SANDBOX'], FILTER_VALIDATE_BOOLEAN)) { ?>checked<?php } ?> <?php if (env('GOCARDLESS_USE_SANDBOX') != null) { ?>disabled<?php } ?>>
              <label class="custom-control-label" for="GOCARDLESS_USE_SANDBOX_TRUE">Use sandbox (development/testing) mode</label>
            </div>
            <div class="custom-control custom-radio">
              <input type="radio" id="GOCARDLESS_USE_SANDBOX_FALSE" name="GOCARDLESS_USE_SANDBOX" class="custom-control-input" <?php if (!filter_var($vars['GOCARDLESS_USE_SANDBOX'], FILTER_VALIDATE_BOOLEAN)) { ?>checked<?php } ?> <?php if (env('GOCARDLESS_USE_SANDBOX')) { ?>disabled<?php } ?>>
