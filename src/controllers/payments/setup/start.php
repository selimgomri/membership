			...
			<div class="mb-3 p-3 bg-white rounded shadow">
				...
				<ul class="mb-0">
					...
					<li>
						...
						Direct Debit <?=CLUB_NAME?> will notify you three working
						days in advance of your account being debited or as otherwise
						agreed. If you request <?=CLUB_NAME?> to collect a payment,
					...
					<li>
						...
						<?=CLUB_NAME?> or your bank or building society, you are
						...
						<ul>
							<li>
								...
								back when <?=CLUB_NAME?> asks you to
							</li>
						</ul>
					</li>
					<li>
