  ...
  <div class="container-fluid">
    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center justify-content-center">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg">
          <a href="http://www.ukmail.com" target="_blank"><img class="img-responsive sponsor center-block"
      ...
      <div class="clearfix visible-sm"></div>-->
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg">
          <a href="http://www.nessswimwear.co.uk" target="_blank"><img class="img-responsive sponsor center-block"
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg">
          <a href="http://www.harlandsaccountants.co.uk" target="_blank"><img
              class="img-responsive sponsor center-block"
              ...
              alt="Harlands Accountants Logo" /></a>
        </div>
      </div>
    </div>
  </div>
  <div class="cls-global-footer cls-global-footer-inverse cls-global-footer-body d-print-none pb-0">
            ...
            <div class="row">
              <div class="col-sm-6 col-lg-6">
                ...
                <ul class="list-unstyled cls-global-footer-link-spacer">
                  ...
                  <li><i class="fa fa-twitter fa-fw" aria-hidden="true"></i> <a title="CLSASC on Twitter"
                      target="_blank" href="https://twitter.com/CLSASC">Twitter</a></li>
                  <li><i class="fa fa-facebook fa-fw" aria-hidden="true"></i> <a title="CLSASC on Facebook"
                      target="_blank"
                      href="https://www.facebook.com/Chester-le-Street-ASC-349933305154137/">Facebook</a></li>
    ...
    <div class="cls-global-footer-legal d-print-none">
      ...
      <div class="container-fluid">
        ...
        ?>
              <p class="hidden-print">Designed and Built by Chester&#8209;le&#8209;Street ASC. Page rendered in
                <?=number_format($seconds, 3)?> seconds.</p>
