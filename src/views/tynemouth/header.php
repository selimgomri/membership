...
<html lang="en-gb">
  <head>
    ...
    <title><?php echo htmlspecialchars($pagetitle, ENT_QUOTES, 'UTF-8'); ?> - <?=htmlspecialchars(env('CLUB_SHORT_NAME'))?> Membership</title>
    <?php }
    else { ?>
    <title><?=htmlspecialchars(env('CLUB_SHORT_NAME'))?> Membership</title>
    <?php } ?>
    <meta name="description" content="Your <?=htmlspecialchars(env('CLUB_NAME'))?> Account lets you make gala entries online and gives you access to all your information about your swimmers, including attendance.">
        ...
        <?php if ($_SESSION['AccessLevel'] == "Parent") { ?>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="swimmersDropdown">
              ...
              <?php } ?>
              <?php } else { ?>
                <a class="dropdown-item" href="<?php echo autoUrl("my-account/addswimmer") ?>">Add Swimmers</a>
              <?php } ?>
            </div>
          </li>
        <li class="nav-item">
      ...
      <ul class="navbar-nav">
        ...
        <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <?php if ($_SESSION['AccessLevel'] == "Parent") { ?>
            <a class="dropdown-item" href="<?php echo autoUrl("my-account/notifyhistory") ?>">Your Message History</a>
